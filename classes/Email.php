...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        $mail->setFrom('cuentas@codicourses.com');
        ...
        $contenido = '<html>';
        $contenido .= "<p><strong>Hola " . $this->nombre . "</strong> Has Registrado Correctamente tu cuenta en Codicourses; pero es necesario confirmarla</p>";
