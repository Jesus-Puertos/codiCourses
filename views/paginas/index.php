...
<section class="speakers">
    <h2 class="speakers__heading">Instructores</h2>
    <p class="speakers__descripcion">Conoce a nuestros expertos de CodiCourses</p>
        ...
        <?php foreach ($ponentes as $ponente) { ?>
            <div <?php aos_animacion(); ?> class="speaker">
                <picture>
                    ...
                    <img class="speaker__imagen" loading="lazy" width="200" height="300"
                ...
                <div class="speaker__informacion">
                    ...
                    <nav class="speaker-sociales">
                        ...
                        <?php if (!empty($redes->facebook)) { ?>
                            <a class="speaker-sociales__enlace" rel="noopener noreferrer" target="_blank"
...
<section class="boletos">
    ...
    <p class="boletos__descripcion">Precios de los cursos</p>

    <div class="boletos__grid">
        <div <?php aos_animacion(); ?> class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;CodiCourses /></h4>
    ...
    <div class="boleto__enlace-contenedor">
        <a href="/paquetes" class="boleto__enlace">Ver Cursos</a>
    </div>
</section>