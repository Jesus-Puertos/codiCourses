<fieldset class="formulario__fieldset">
    <legend class="formulario__legend">Información Curso</legend>

    <div class="formulario__campo">
        <label for="nombre" class="formulario__label">Nombre Curso</label>
    ...
    <div class="formulario__campo">
        <label for="categoria" class="formulario__label">Categoría o Tipo de Curso</label>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="ponentes" class="formulario__label">Instructor</label>
        <input type="text" class="formulario__input" id="ponentes" placeholder="Buscar Instructor">
